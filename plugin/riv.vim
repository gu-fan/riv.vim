...
let s:default.opts = {
    ...
    \'fold_level'           : 3,
    \'list_toggle_type'     : "*,#.,(#)",
    \'localfile_linktype'   : 0,
    \'web_browser'          : "firefox",
    \'options'              : s:default,
    \}
let s:default.maps = {
    \'RivIndex'          : 'call <SID>exe_proj("index")',
    \'RivLinkOpen'       : 'call riv#link#open2()',
    ...
    \'RivCreateFootnote' : 'call riv#link#create("footnote",1)',
    \'RivTestReload'     : 'let g:riv_force=1 | set ft=rst | let g:riv_force=0',
