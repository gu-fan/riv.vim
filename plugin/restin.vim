...
let g:restin_projects = !exists("g:restin_projects") ? s:set_proj(g:restin_proj_temp) : 
            \ s:set_proj(g:restin_projects)
...
let s:opts = {    
            ...
            \}
let s:maps = {
    \'RformatTable' : ['restin#table#format()', 'rf', ''],
    \'RaddRow'      : ['restin#table#newline()', '', 'n'],
    \'Rindex'       : ['call s:exe_proj(0,"index")', 'rr', 'n'],
    \}

call s:default(s:opts)
