...
\},
\{'name': 'RivCreateLiteralBlock' , 'act': ":call riv#create#literal_block()<CR>",
    \'note': 'LiteralBlock',
    \'menu': 'Insert.LiteralBlock',
    \'type': 'buf', 'mode': 'ni', 'maps': ['cb'], 'keys': [],
\},
\{'name': 'RivCreateHyperLink' , 'act': ":call riv#create#hyperlink()<CR>",
    \'note': 'HyperLink',
    \'menu': 'Insert.HyperLink',
    \'type': 'buf', 'mode': 'ni', 'maps': ['ch'], 'keys': [],
\},
\{'name': 'RivCreateTransition' , 'act': ":call riv#create#transition()<CR>",
    \'note': 'Transition',
    \'menu': 'Insert.Transition',
    \'type': 'buf', 'mode': 'ni', 'maps': ['cr'], 'keys': [],
\},
\{'name': 'RivCreateExplicitMark' , 'act': ":call riv#create#exp_mark()<CR>",
    \'note': 'ExplicitMark',
